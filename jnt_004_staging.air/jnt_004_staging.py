...
#     text("自动化测试，用于调试",enter=False)
    ...
    sleep(1)
    swipe(Template(r"tpl1705387071277.png", record_pos=(-0.359, 0.748), resolution=(1080, 1920)), vector=[-0.0387, -0.7708])
    sleep(1)
    swipe(Template(r"tpl1705387091194.png", record_pos=(-0.351, 0.843), resolution=(1080, 1920)), vector=[-0.0366, -0.6353])
    sleep(2)
...
def draft_to_submit():
    ...
    sleep(1)
    swipe(Template(r"tpl1705632891643.png", record_pos=(-0.364, 0.794), resolution=(1080, 1920)), vector=[-0.0262, -0.7917])
    sleep(1)
    swipe(Template(r"tpl1705632914384.png", record_pos=(-0.262, 0.693), resolution=(1080, 1920)), vector=[-0.1111, -0.7243])
...
def to_do_list():
    ...
    sleep(1)
    swipe(Template(r"tpl1705544057163.png", record_pos=(-0.374, 0.394), resolution=(1080, 1920)), vector=[-0.0363, -0.5555])
    sleep(1)
    swipe(Template(r"tpl1705544143518.png", record_pos=(-0.254, 0.602), resolution=(1080, 1920)), vector=[-0.1171, -0.6979])
    sleep(1)
    ## 抄送给陈文哲
    sleep(1)
