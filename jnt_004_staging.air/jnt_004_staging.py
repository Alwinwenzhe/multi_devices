...
def dispatch():
    ...
    sleep(3)
    swipe(Template(r"tpl1704768451248.png", record_pos=(-0.133, 0.787), resolution=(1260, 2800)), vector=[0.0562, 0.0009])
...
def draft_to_submit():
    ...
    sleep(1)
    swipe(Template(r"tpl1706581546394.png", record_pos=(-0.294, 0.662), resolution=(1080, 1920)), vector=[-0.0788, -0.7123])
...
def chat_need_to_be_deal():
    ...
    assert_exists(Template(r"tpl1706843805922.png", record_pos=(0.011, 0.101), resolution=(1080, 1920)), "流程图比对正确")
    ### 验证处理日志
    touch(Template(r"tpl1706843935616.png", record_pos=(0.316, -0.376), resolution=(1080, 1920)))
    sleep(1)
    assert_exists(Template(r"tpl1706843972588.png", record_pos=(-0.258, -0.083), resolution=(1080, 1920)), "出纳审批日志正确")
    assert_exists(Template(r"tpl1706843992369.png", record_pos=(-0.232, 0.506), resolution=(1080, 1920)), "财务部长审批日志正确")
    swipe(Template(r"tpl1706844015158.png", record_pos=(-0.302, 0.349), resolution=(1080, 1920)), vector=[-0.0307, -0.5798])
    sleep(1)
    assert_exists(Template(r"tpl1706844037592.png", record_pos=(-0.232, 0.074), resolution=(1080, 1920)), "会计审批日志正确")
    assert_exists(Template(r"tpl1706844068010.png", record_pos=(-0.237, 0.66), resolution=(1080, 1920)), "上级审批日志正确")
    swipe(Template(r"tpl1706844267889.png", record_pos=(-0.282, -0.239), resolution=(1080, 1920)), vector=[0.0021, 0.5596])
    sleep(1)
    ### 验证表单中得抄送等审批按钮
